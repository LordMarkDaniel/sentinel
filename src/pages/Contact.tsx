...
import { Phone, Mail, MapPin, Clock, Send, ArrowLeft, Linkedin, Facebook, Instagram } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pt-32 pb-20">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-secondary rounded-xl p-8 md:p-12 mb-16 text-center relative overflow-hidden">
          ...
          <h1 className="text-3xl md:text-4xl font-display font-bold text-secondary-foreground mb-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-secondary p-8 rounded-xl border border-border/20 group hover:border-primary/50 transition-all hover:shadow-lg">
            <h2 className="text-2xl font-display font-bold text-secondary-foreground mb-6">
